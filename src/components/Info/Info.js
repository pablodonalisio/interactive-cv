        ...
        <div className="info-content">
          ...
          {lang === "ES" && (
            <section>
              ...
              <p>
                Para esto solo debes buscar el ícono correspondiente a la acción
                que deseas realizar:
              </p>
              <ul>
                <li>
          ...
          {lang === "EN" && (
            <section>
              <p>
                Hi! I've created this interactive CV so you can filter or expand
                the information if you want to.
              </p>
              <p>
                To do so you just have to look for the corresponding icon to the
